...
public partial class Form1 : Form
{
    ...
    private void btnLnx_Click(object? sender, EventArgs e){
        ...
        txtDisplay.Text=Math.Log(Double.Parse(txtDisplay.Text),2.718).ToString();
    }
    ...
    private void btnBin_Click(object? sender, EventArgs e){
        if(!txtDisplay.Text.Contains(".")){
            if(!txtDisplay.Text.Contains("2") && !txtDisplay.Text.Contains("3") && !txtDisplay.Text.Contains("4") && 
            !txtDisplay.Text.Contains("5") && !txtDisplay.Text.Contains("6") && !txtDisplay.Text.Contains("7") &&
            !txtDisplay.Text.Contains("8") && !txtDisplay.Text.Contains("9")){
            lblOperacion.Text=$"Bin({txtDisplay.Text}) =";
            String bin=txtDisplay.Text;
    ...
    private void btnHex_Click(object? sender, EventArgs e){
        if(!txtDisplay.Text.Contains(".")){
            if(!txtDisplay.Text.Contains("A") && !txtDisplay.Text.Contains("B") && !txtDisplay.Text.Contains("C")&&
            !txtDisplay.Text.Contains("D")&&!txtDisplay.Text.Contains("E")&&!txtDisplay.Text.Contains("F")){
            lblOperacion.Text=$"Hex({txtDisplay.Text}) =";
            int intValue = Int32.Parse(txtDisplay.Text);
            string hexValue=intValue.ToString("X");
            txtDisplay.Text=hexValue;
            }else{
                lblOperacion.Text=$"Hex({txtDisplay.Text}) =";
                String myHex=txtDisplay.Text;
                int myNewInt = Convert.ToInt32(myHex, 16); 
                txtDisplay.Text=myNewInt.ToString();
